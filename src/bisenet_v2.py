...
class ConvBNReLU(nn.Module):
    def __init__(self, in_chan, out_chan, ks=3, stride=1, padding=1, dilation=1):
        ...
        self.conv = nn.Conv2d(in_chan, out_chan, kernel_size=ks, stride=stride, padding=padding, dilation=dilation, bias=False)
...
class SegmentBranch(nn.Module):
    ...
    def forward(self, x):
        ...
        return feat2, feat3, feat4, feat5_5
...
class BiSeNetV2(nn.Module):
    ...
    def forward(self, x):
        ...
        feat2, feat3, feat4, feat5_4 = self.segment(x)
        feat_head = self.bga(feat_d, feat5_4)
